...
export class SeedConfig {
  ...
  BOOTSTRAP_MODULE     = this.ENABLE_HOT_LOADING ? 'hot_loader_main' : './admin/main';
  ...
  TMP_CSS_DEST         = `${this.TMP_DIR}/css`;
  MAIN_CSS             = this.ENV === 'prod'?
    `${this.TMP_DIR}/css/${this.CSS_DIR}/main.css`:
    `${this.DEV_DEST}/css/${this.CSS_DIR}/main.css`;
  /**
   * FONTS CONFIG
   */
  FONTS_DIR            = `${this.ASSETS_DIR}/fonts`;
