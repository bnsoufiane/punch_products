...
import {PopOverTargetEvent} from '../../interfaces/interfaces';
import {PopOverConfig} from "../../interfaces/inter-component-contracts/staffing-popover-contract.interface";
...
export class StaffingPopoverDirective implements OnDestroy {
  ...
  private onHover(event):void {
    ...
    (function () {
      ...
      setTimeout(function () {
        ...
        //then open popover
        this.setPopoverPosition(thisEvent);
  ...
  private setPopoverPosition(event) {
