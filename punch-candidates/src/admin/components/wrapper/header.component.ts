...
@Component({
  ...
  styleUrls: ['../../../css/admin/assets/stylesheets/components/navbar.css']
})
export class HeaderComponent {
  ...
  isActive(section:string) {
    ...
    if(section === 'Home' && ['CandidateListComponent', 'CandidateDetailComponent'].indexOf(currentComponentName) > -1) {
      return true;
    }
    return false;
  }
