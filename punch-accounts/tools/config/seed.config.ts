...
export class SeedConfig {
  ...
  CONFIG_SRC           = 'config';
  CONFIG_FILE          = `${this.CONFIG_SRC}/config.js`;
   ...
   * CSS CONFIG
   */
  CSS_DIR              = `${this.ASSETS_DIR}/stylesheets`;
  CSS_SRC              = `${this.APP_SRC}/${this.CSS_DIR}`;
  CSS_DEST             = `${this.APP_DEST}/common/stylesheets`;
  TMP_CSS_DEST         = `${this.TMP_DIR}`;
  MAIN_CSS             = this.ENV === 'prod'?
    `${this.TMP_DIR}/${this.CSS_DIR}/main.css`:
    `${this.DEV_DEST}/${this.CSS_DIR}/main.css`;
  /**
   * FONTS CONFIG
   */
  FONTS_DIR            = `src/${this.ASSETS_DIR}/fonts`;
  FONTS_DEST           = `${this.APP_DEST}/common/fonts`;
  ...
  APP_ASSETS: InjectableDependency[] = [
    { src: `${this.MAIN_CSS}`, inject: true, vendor: false }
  ];
